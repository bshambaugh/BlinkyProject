...
function runAllTasks(tasks, options, context) {
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const orchestrator = new task_orchestrator_1.TaskOrchestrator(context.hasher, context.initiatingProject, context.projectGraph, context.taskGraph, options, (_a = context.nxArgs) === null || _a === void 0 ? void 0 : _a.nxBail);
