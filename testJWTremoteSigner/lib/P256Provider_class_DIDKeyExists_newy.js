...
websocketServer.on('stream', function (stream, request) {
    ...
    setInterval(function () {
        (async function () {
            ...
            const publicKey = 'f9c36f8964623378bdc068d4bce07ed17c8fa486f9ac0c2613ca3c8c306d7bb61cd36717b8ac5e4fea8ad23dc8d0783c2318ee4ad7a80db6e0026ad0b072a24f';
            const multicodecName = 'p256-pub';
            if (DIDKeyExists === publicKey) {
                console.log('they are equal');
            }
            else {
                console.log('they are not equal');
                console.log('DIDKeyExists are publicKey are');
...
async function matchDIDKeyWithRemote(didkeyURL, stream) {
    ...
    const publicKey = publicKeyIntToUint8ArrayPointPair(ECPointDecompress((0, from_string_1.fromString)(compressedPublicKey, 'hex')));
    console.log(publicKey);
...
//# sourceMappingURL=P256Provider_class_DIDKeyExists_newy.js.map