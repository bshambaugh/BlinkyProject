...
console.log("break");
console.log(message_ht.values);
console.log(message_ht.values[message_ht.calculateHash("131")]["131"]);
console.log(message_ht.values[message_ht.calculateHash("132")]["132"]);
message_ht.remove("132");
console.log(message_ht.values);
console.log(message_ht.length);
console.log(message_ht.length - 1);
console.log(message_ht);
message_ht.search("131");
